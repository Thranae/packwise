...
import { LayoutGrid, Map, Box, Wallet, Bot, FileText, User, Settings, Calendar, Compass, Plane, BookOpen } from 'lucide-react';
...
const navItems = [
  ...
  { label: 'AI Planner', path: '/assistant', icon: Bot, colorClass: 'group-hover:text-purple-400 group-hover:drop-shadow-[0_0_8px_rgba(192,132,252,0.8)]' },
