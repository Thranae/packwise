...
export function AppLayout({ children }) {
  ...
  return (
    <>
      ...
      <BottomNav />
      <LayoutGroup>
        <div className="relative z-10 flex flex-col min-h-screen px-4 pb-[calc(80px+var(--safe-bottom))] pt-2 lg:pl-[288px] lg:pr-8 lg:pb-8 lg:pt-0 w-full overflow-x-clip">
