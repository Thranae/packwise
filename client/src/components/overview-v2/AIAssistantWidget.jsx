...
export const AIAssistantWidget = ({ className = "" }) => {
  ...
  return (
    <motion.div 
      ...
      className={`relative p-4 sm:p-5 flex flex-col justify-between h-auto min-h-[300px] max-h-[450px] sm:max-h-none sm:h-[600px] rounded-[24px] sm:rounded-[32px] overflow-hidden ios-glass-card group cursor-pointer ${className}`}
    >
