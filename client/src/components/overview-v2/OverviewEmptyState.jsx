...
export const OverviewEmptyState = () => {
  ...
  return (
    <motion.div 
      ...
      className="col-span-12 flex flex-col items-center justify-center min-h-[60vh] rounded-[32px] md:rounded-[40px] ios-glass-card shadow-2xl relative overflow-hidden p-8 text-center"
    >
