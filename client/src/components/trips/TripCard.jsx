    ...
    >
      ...
      <div className="p-6 flex flex-col justify-between flex-1 relative ios-3d-element bg-transparent">
        ...
        <div className="mt-5 relative z-20 ios-3d-element">
          <button onClick={() => { selectTrip(trip._id); navigate(ROUTES.OVERVIEW); }} className="w-full flex items-center justify-center py-3.5 rounded-[16px] ios-liquid-button text-white font-bold text-sm tracking-wide transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] hover:scale-[1.03] hover:-translate-y-1 hover:shadow-[0_16px_32px_rgba(59,130,246,0.3),inset_0_2px_4px_rgba(255,255,255,0.4)] cursor-pointer group/btn">
            Open Trip Overview
          </button>
        </div>
