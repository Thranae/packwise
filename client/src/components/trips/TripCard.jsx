...
export const TripCard = ({ trip }) => {
  ...
  return (
    <div className="relative w-full h-[460px] rounded-[32px] overflow-hidden group/swipe">
      {/* Background Swipe Action (Delete) */}
      <div className="absolute inset-0 bg-red-500 flex items-center justify-end px-8 rounded-[32px]">
        <div className="flex flex-col items-center justify-center text-white gap-2 opacity-0 group-hover/swipe:opacity-100 transition-opacity">
      ...
      <motion.div 
        ...
        dragElastic={0.2}
        style={{ x, rotateX, rotateY, transformPerspective: 1200 }}
