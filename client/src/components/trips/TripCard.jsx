...
export const TripCard = ({ trip }) => {
  ...
  return (
    <motion.div 
      ...
      className="relative flex flex-col h-[460px] w-full rounded-[32px] overflow-hidden ios-glass-card cursor-pointer transform-gpu [transform-style:preserve-3d] will-change-transform bg-black"
      onClick={(e) => {
        selectTrip(trip._id);
