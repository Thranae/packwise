...
import { Bot, Send, Search, MapPin, ArrowUp, Loader2 } from 'lucide-react';
    ...
    >
      ...
      <div className="flex flex-col items-center gap-2 mb-4 shrink-0 ios-3d-element">
        <div className="relative w-12 h-12 rounded-[16px] bg-gradient-to-br from-blue-500/20 to-purple-500/20 border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.2),0_4px_12px_rgba(0,0,0,0.3)] flex items-center justify-center backdrop-blur-xl">
          <Bot className="w-6 h-6 text-white drop-shadow-[0_2px_8px_rgba(255,255,255,0.6)]" />
          ...
          >
            <div className={`flex items-center gap-2 mb-1 px-1 ${msg.role === 'user' ? 'flex-row-reverse' : ''}`}>
              {msg.role === 'user' ? (
                ...
                <div className="w-5 h-5 rounded-[6px] bg-gradient-to-br from-blue-500/20 to-purple-500/20 border border-white/10 flex items-center justify-center text-[10px] font-bold text-white shadow-md"><Bot className="w-3 h-3 text-white" /></div>
              )}
          ...
          {isLoading && (
            ...
            >
              <div className="flex items-center gap-2 mb-1 px-1">
                <div className="w-5 h-5 rounded-[6px] bg-gradient-to-br from-blue-500/20 to-purple-500/20 border border-white/10 flex items-center justify-center text-[10px] font-bold text-white shadow-md"><Bot className="w-3 h-3 text-white animate-pulse" /></div>
