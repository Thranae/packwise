...
const InspirationCarousel = ({ step, onSelectDestination, onSelectSeason, onSelectStyle }) => {
  ...
  const destinations = [
    ...
    { id: 7, title: 'Kyoto, Japan', subtitle: 'Zen & Temples', image: `https://images.unsplash.com/photo-1545569341-9eb8b30979d9?auto=format&fit=crop&w=400&q=80` },
    ...
    { id: 13, title: 'Amalfi Coast', subtitle: 'Italian Charm', image: `https://images.unsplash.com/photo-1534308983496-4fabb1a015ee?auto=format&fit=crop&w=400&q=80` },
  ...
  const seasons = [
    ...
    { id: 6, title: 'Spring in Japan', subtitle: 'Mar - May', image: `https://images.unsplash.com/photo-1490806843957-31f4c9a91c65?auto=format&fit=crop&w=400&q=80`, date: '2027-04-10', duration: 12 },
    { id: 7, title: 'Mediterranean', subtitle: 'Jun - Sep', image: `https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?auto=format&fit=crop&w=400&q=80`, date: '2027-06-20', duration: 14 },
    ...
    { id: 11, title: 'Oktoberfest', subtitle: 'Sep - Oct', image: `https://images.unsplash.com/photo-1567982047351-76b6f93e38ee?auto=format&fit=crop&w=400&q=80`, date: '2026-09-20', duration: 10 },
    ...
    { id: 14, title: 'Spring Break', subtitle: 'Mar - Apr', image: `https://images.unsplash.com/photo-1473116763249-2faaef81ccda?auto=format&fit=crop&w=400&q=80`, date: '2027-03-15', duration: 7 },
    { id: 15, title: 'Festive Markets', subtitle: 'Dec', image: `https://images.unsplash.com/photo-1512389142860-9c449e58a814?auto=format&fit=crop&w=400&q=80`, date: '2026-12-05', duration: 10 }
  ];
