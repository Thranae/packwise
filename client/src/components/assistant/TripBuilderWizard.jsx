...
<div className="w-full h-full flex flex-col lg:flex-row items-start justify-start gap-8 max-w-[1400px]">
      <div className="flex flex-col items-start w-full h-full lg:flex-1 lg:max-w-4xl relative z-10">
        ...
        <div className="flex items-center justify-between mb-6 sm:mb-8 relative z-10 px-2 sm:px-6 shrink-0">
          ...
          <div 
            className="absolute top-1/2 left-6 h-[3px] bg-gradient-to-r from-blue-400 to-indigo-500 rounded-full -z-10 transition-[width] duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] shadow-[0_0_15px_rgba(59,130,246,0.6)]" 
          ...
          {steps.map((s) => {
            ...
            return (
              <div key={s.id} className="flex flex-col items-center gap-3 relative">
                <div className={`w-12 h-12 sm:w-14 sm:h-14 rounded-[20px] flex items-center justify-center transition-[transform,background-color,color,border-color] duration-500 relative group ${
                  isActive || isPast 
                  ...
                  {isActive && <div className={`absolute -inset-4 bg-gradient-to-r ${s.color} rounded-full opacity-30 blur-2xl -z-10`} />}
                        ...
                        <div className="flex items-center gap-4">
                          <div className="flex items-center gap-2 bg-white/[0.03]  border-[1.5px] border-white/10 border-t-white/30 border-l-white/20 p-2 rounded-[28px] shadow-[0_12px_32px_rgba(0,0,0,0.3),inset_0_2px_8px_rgba(255,255,255,0.1)]">
                            <button 
                              ...
                              className="w-12 h-12 flex items-center justify-center rounded-full bg-white/5 hover:bg-white/10 hover:shadow-[0_4px_16px_rgba(0,0,0,0.3),inset_0_2px_8px_rgba(255,255,255,0.2)] active:scale-90 transition-[transform,background-color] duration-200 text-white/60 hover:text-white group border border-transparent hover:border-white/10"
                            >
                        ...
                        {['Budget', 'Moderate', 'Luxury'].map((b) => {
                          ...
                          return (
                            <div 
                              key={b} 
                              onClick={() => setBudget(b)}
                              className={`group/budget relative overflow-hidden rounded-[16px] sm:rounded-[24px] p-2 sm:p-6 flex flex-col items-center justify-center cursor-pointer transition-[transform,background-color,border-color] duration-400 ${
                                isActive 
                        ...
                        {['Fast-paced', 'Relaxed', 'Culture', 'Nature', 'Foodie', 'Luxury'].map((style) => {
                          ...
                          return (
                            <div 
                              ...
                              className={`rounded-[20px] px-4 py-4 sm:px-6 sm:py-5 text-center cursor-pointer transition-[transform,background-color,border-color] duration-300 ${
                                isActive 
                ...
                <div className="flex items-center justify-between mt-4 sm:mt-5 pt-3 sm:pt-4 border-t border-white/10 relative z-10 shrink-0">
                  ...
                  {step < 3 ? (
                    ...
                    <button 
                      ...
                      className="flex items-center gap-2 sm:gap-3 h-12 sm:h-14 px-6 sm:px-8 rounded-full bg-gradient-to-r from-emerald-400/90 to-teal-500/90  border-[1.5px] border-white/40 border-t-white/70 border-l-white/60 disabled:opacity-50 transition-[transform,background-color,opacity] duration-300 shadow-[0_12px_24px_rgba(52,211,153,0.5),inset_0_4px_12px_rgba(255,255,255,0.4)] group hover:scale-[1.02] hover:-translate-y-[2px] hover:shadow-[0_16px_32px_rgba(52,211,153,0.6),inset_0_6px_16px_rgba(255,255,255,0.5)]"
                    >
                ...
                >
                  {suggestions.map((loc, idx) => (
                    <motion.button
                      ...
                      className="w-full flex items-center gap-4 px-4 py-3 rounded-[20px] transition-[background-color,border-color] duration-300 text-left group/item relative overflow-hidden bg-transparent hover:bg-white/[0.06] border border-transparent hover:border-white/10"
                    >
