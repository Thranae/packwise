...
export default function ExplorePage() {
    ...
    const fetchAllImages = async () => {
      ...
      try {
        ...
        const cards = CARD_CATEGORIES.map((cat, i) => ({
          ...
          img: results[i] || 'https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?q=80&w=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
        }));
  ...
  return (
    <div className="col-span-12 w-full min-h-screen flex flex-col pt-[calc(32px+var(--safe-top))] md:pt-8 pb-20 relative">
      <AnimatePresence>
        {toast && (
