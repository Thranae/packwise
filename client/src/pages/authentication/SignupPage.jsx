  ...
  return (
    ...
    >
      ...
      <div className="mb-3 flex justify-start">
        <img src="/pwa-192x192.png" alt="Voyage Genie" className="w-12 h-12 rounded-[12px] shadow-sm object-cover" />
      </div>
        ...
        <div>
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <User className="h-4 w-4 text-[var(--theme-text-secondary)] opacity-70" />
            </div>
            <input
              type="text"
              placeholder="Full Name"
              {...register('name')}
              className={`w-full h-[46px] glass-input pl-10 pr-4 text-[14px] font-medium placeholder-[var(--theme-text-secondary)] transition-all ${errors.name ? '!border-red-500' : ''}`}
            />
          </div>
          {errors.name && (
          ...
          <div className="w-1/2">
            <div className="relative">
              ...
              <input
                ...
                className={`w-full h-[46px] glass-input pl-10 pr-10 text-[14px] font-medium placeholder-[var(--theme-text-secondary)] transition-all ${errors.confirmPassword ? '!border-red-500' : ''}`}
              />
              <button
                type="button"
                ...
                className="absolute inset-y-0 right-0 pr-3 flex items-center text-[var(--theme-text-secondary)] hover:text-[var(--theme-text-primary)] transition-colors"
              >
                {showConfirmPassword ? <EyeOff className="h-4 w-4 opacity-70" /> : <Eye className="h-4 w-4 opacity-70" />}
              </button>
            </div>
