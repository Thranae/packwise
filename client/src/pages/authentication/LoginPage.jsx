      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
        ...
        <div>
          <div className="relative">
            ...
            <button
              ...
              className="absolute inset-y-0 right-0 pr-4 flex items-center text-[var(--theme-text-secondary)] hover:text-[var(--theme-text-primary)] transition-colors"
            >
        ...
        <div className="flex items-center justify-between mt-1 mb-2">
          <label className="flex items-center gap-2 cursor-pointer group">
            <div className="relative w-4 h-4 rounded-[4px] border border-[var(--theme-border-subtle)] bg-[var(--theme-bg-glass)] group-hover:border-[var(--color-accent)] transition-colors flex items-center justify-center">
              <input type="checkbox" className="opacity-0 absolute inset-0 cursor-pointer" />
            </div>
            <span className="text-[13px] font-medium text-[var(--theme-text-secondary)] group-hover:text-[var(--theme-text-primary)] transition-colors">Remember me</span>
          </label>
          <Link
        ...
        <div className="relative my-4">
          ...
          <div className="relative flex justify-center text-[12px]">
            <span className="px-3 bg-transparent backdrop-blur-md rounded-full border border-[var(--theme-border-subtle)] py-1 text-[var(--theme-text-secondary)] font-medium">or sign in with</span>
          </div>
        </div>
