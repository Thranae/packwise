...
import { Package, Plus, CheckCircle2, Circle, MoreVertical, Bot, Clock, CloudRain, Sun, Thermometer, Scale, FileText, AlertTriangle, Briefcase, Home, Power, ShoppingCart, MessageSquare, X, Send, Scan, Users, Bell, Smartphone, MapPin, Shuffle, Shirt, Camera, Umbrella, Glasses, Headphones, Footprints, GripVertical, Check, RefreshCw } from 'lucide-react';
    ...
    try {
      ...
      const fetchFor = async (query) => {
        try {
          ...
          const menMocks = [
            'https://picsum.photos/seed/1516826957135-700ede19c6ce/1600/900',
            'https://picsum.photos/seed/1617137968427-85924c800a22/1600/900',
            'https://picsum.photos/seed/1480455624313-e29b44bbfde1/1600/900',
            'https://picsum.photos/seed/1552374196-1ab2a1c593e8/1600/900'
          ];
          const womenMocks = [
            'https://picsum.photos/seed/1483985988355-763728e1935b/1600/900',
            'https://picsum.photos/seed/1515886657613-9f3515b0c78f/1600/900',
            'https://picsum.photos/seed/1495385794356-15371f348c31/1600/900',
            'https://picsum.photos/seed/1529139574466-a303027c1d8b/1600/900'
          ];
      ...
      <div className="w-full pt-[calc(32px+var(--safe-top))] md:pt-8 pb-24">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-10 z-20 relative">
          ...
          >
            ...
            >
              <Bot className={`w-5 h-5 drop-shadow-md transition-transform duration-300 ${isMagicPacking ? 'animate-bounce text-yellow-300' : 'group-hover:rotate-12 group-hover:scale-110'}`} strokeWidth={2.5} />
        ...
        <div className="flex justify-center mb-8 z-20 relative">
          <div className="ios-glass-card p-1.5 flex gap-2 rounded-full border border-white/10 bg-black/40 backdrop-blur-sm shadow-[inset_0_2px_4px_rgba(0,0,0,0.4)]">
            ...
            >
              <Bot className={`w-4 h-4 ${activeTab === 'moodboard' ? 'text-blue-300' : 'text-white/50'}`} /> Outfit Mood Board
            </button>
          </div>
        </div>
            ...
            <div className="ios-glass-card p-6 bg-gradient-to-br from-indigo-900/40 to-blue-900/40 rounded-[32px]">
              <div className="flex gap-4 ios-3d-element">
                <div className="w-10 h-10 shrink-0 rounded-full bg-blue-500/20 flex items-center justify-center shadow-[inset_0_2px_4px_rgba(255,255,255,0.2)]">
                  <Bot className="w-5 h-5 text-blue-300 drop-shadow-[0_0_8px_rgba(147,197,253,0.8)]" />
                </div>
                <div>
                  ...
                  >
                    ...
                    <div className="mt-auto pt-6 shrink-0">
                      <button onClick={() => setIsAiModalOpen(true)} className="ios-liquid-button w-full h-12 rounded-[20px] bg-gradient-to-r from-amber-500/20 to-orange-500/20 text-amber-100 font-bold tracking-wide transition-all duration-300 flex items-center justify-center gap-2 group/btn relative overflow-hidden">
                        ...
                        <Bot className="w-5 h-5 text-amber-300 group-hover/btn:scale-110 transition-transform" />
                        Ask AI what to buy...
                      </button>
                    </div>
                  </motion.div>
            ...
            <div className="flex justify-between items-center w-full px-2 mt-4 mb-2">
              <div className="flex items-center gap-3">
                <h2 className="text-xl md:text-2xl font-bold text-white tracking-wide flex items-center gap-2 drop-shadow-md">
                  <Bot className="w-5 h-5 text-indigo-400" /> {currentTrip?.destination?.split('&')[0]} Street Style
                </h2>
