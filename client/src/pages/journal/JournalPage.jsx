...
import { Book, Plus, Image as ImageIcon, MapPin, Calendar as CalendarIcon, Smile, Sun, Cloud, CloudRain, Snowflake, Wind, Coffee, Heart, Camera, ChevronDown, Check, X, Clock, Send, Bot, Loader2 } from 'lucide-react';
          ...
          >
            ...
            <div className="flex items-center gap-4 relative z-10">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center shadow-lg shadow-purple-500/30">
                {isGeneratingStory ? <Loader2 className="w-6 h-6 text-white animate-spin" /> : <Bot className="w-6 h-6 text-white" />}
              </div>
