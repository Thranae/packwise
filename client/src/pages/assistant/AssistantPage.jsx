...
export default function AssistantPage() {
  ...
  return (
    <PageTransition className="col-span-12">
      <div className="min-h-screen px-4 sm:px-6 md:px-10 lg:px-12 pb-24 pt-6 flex flex-col items-start w-full relative z-10">
        
        {/* Unified Header & Segmented Control */}
        <div className="w-full max-w-4xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 mb-10 z-20 relative">
